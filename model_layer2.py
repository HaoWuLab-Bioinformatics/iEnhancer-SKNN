...
x_train = np.loadtxt('./Features/enhancer_classification/features_layer1_train.txt')
y_train = np.loadtxt('./Features/enhancer_classification/lable_layer1_train.txt')
x_test = np.loadtxt('./Features/enhancer_classification/features_layer1_test.txt')
y_test = np.loadtxt('./Features/enhancer_classification/lable_layer1_test.txt')

base_model1 = KNeighborsClassifier(leaf_size=1, n_neighbors=2, p=1, weights='distance')
base_model2 = KNeighborsClassifier(leaf_size=1, n_neighbors=4, p=1, weights='distance')
base_model3 = KNeighborsClassifier(leaf_size=1, n_neighbors=6, p=1, weights='distance')
base_model4 = KNeighborsClassifier(leaf_size=1, n_neighbors=8, p=1, weights='distance')
base_model5 = KNeighborsClassifier(leaf_size=1, n_neighbors=5, p=1, weights='distance')
...
print('The performance of enhancer classification：')
